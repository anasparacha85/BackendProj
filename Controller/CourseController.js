const Courses=require('../Model/CoursesModal')
const Lessons=require('../Model/LessonModal')
...
module.exports={uploadCourses,getAllCourses,getcoursebyid,addlessonsbycourseid,enrolledStudent,getEnrolledCourses,CoursesCount,CourseCountbbyName,CourseCountbbyCategory,DeleteCourses,AddFavourites,RemoveFavourites,getAllFavourites}